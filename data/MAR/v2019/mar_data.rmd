...
#### 2.1.3 Finland: rainbow trout mariculture
...
palProd <- leaflet::colorNumeric("RdYlBu", log10(seq(1, 10, 0.1))*10000, "#fcfcfd", reverse = TRUE)
palN <- leaflet::colorNumeric("RdYlBu", seq(0, 55, 0.5), "#fcfcfd", reverse = TRUE)
palP <- leaflet::colorNumeric("RdYlBu", seq(0, 7.7, 0.05), "#fcfcfd", reverse = TRUE)
...
leaflet(data = plotshp) %>% 
  ...
  addPolygons(
    popup = paste(
      ...
      round(plotshp$produced_tonnes, 0), "</h5>",
