...
knitr::kable(tab, format = "html", caption = "Source: [ICES Database](http://dome.ices.dk/views/ContaminantsBiota.aspx) <br/> Downloaded 22 April 2019 by Ellie Campbell") %>% 
...
htmlTable::htmlTable(pcb_congeners, align = "lr", col.rgroup = c("none", "#8D909E"))
```
<br/>
...
knitr::kable(tab, format = "html", caption = "Source: [ICES Database](http://dome.ices.dk/views/ContaminantsSediment.aspx) <br/> Downloaded 13 February 2020 by Ellie Campbell") %>% 
  kableExtra::kable_styling(latex_option = c("hold_position"), position = "left")
```
<br/>
...
htmlTable::htmlTable(dioxin_congeners, align = "lr", col.rgroup = c("none", "#8D909E"))
```
<br>
...
```{r combining con data for initial exploration, echo = TRUE, warning = FALSE, message = FALSE}
