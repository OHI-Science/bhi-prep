...
```{r map showing oxygen datasets, results = "show", message = FALSE, warning = FALSE, echo = TRUE, fig.height = 20, fig.width = 9.5}
dir_interm <- here::here("data", "CW", "eutrophication", version_year, "intermediate")
...
oxtsplot <- ggplot(tsplotdf, aes(Date, Oxygen, color = measure_type)) + 
  ...
  labs(x = "Year", y = "Dissolved Oxygen (ml/l, Bottle data in pink and CTD data in Blue)")


gridExtra::grid.arrange(oxmap, ctdmap, nrow = 1, widths = c(1, 1.4))
