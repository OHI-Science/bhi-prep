...
oxtsplot <- ggplot(plotdf, aes(Date, Oxygen, color = Year)) + 
  geom_point(size = 0.1, alpha = 0.01, show.legend = FALSE) +
  facet_wrap(~Assessment_Unit, ncol = 3) +
  labs(x = NULL, y = "Dissolved Oxygen (ml/l)", title = "Breathing of the Baltic Sea!") +
  scale_color_viridis_c(option = "plasma")

gridExtra::grid.arrange(
  oxmap, oxplot, oxtsplot, 
  layout_matrix = matrix(c(rep(c(1,1,1,2,2),3), rep(c(3,3,3,2,2),3)), ncol = 5, byrow = TRUE)
)
```
