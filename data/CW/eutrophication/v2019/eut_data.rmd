...
basin_lookup <-  read.csv(file.path(dir_lookup, "bhi_basin_country_lookup.csv"), sep=";")
basin_lookup <- basin_lookup %>% 
  dplyr::select(bhi_id = BHI_ID, basin_name=Subbasin)
