...
secchi_target <- eut_thresholds %>% 
  ...
  mutate(Subbasin = str_replace_all(Subbasin, "_", " "),
         secchi_target = as.character(secchi_target))   
...
oxyg_rgns_shp <- join_rgns_info(
  class(oxygen), helcomID_col = "helcom_id", country_col = "country", 
                           latlon_vars = c("^lat", "^lon"), return_spatial = FALSE, 
                           rgn_shps_loc = file.path(dir_B, "Shapefiles"), buffer_shp = NULL)
