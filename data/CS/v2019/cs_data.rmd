...
The data set is showing seagrass meadows in the Baltic Sea area as points used for the [BRISK project](http://www.brisk.helcom.fi/) (Sub-regional risk of spill of oil and hazardous substances in the Baltic Sea). This dataset has been produced by [COWI](http://www.cowi.dk) based on data from HELCOM.
...
Reference_condition = field description of 2 (ie. present after 1995) ???
...
We will only explore the dataset chose by BHI 1.0 (Alternative 4), unless new available better data.
...
```{r polygon data explore, echo=FALSE, message=FALSE}
## inspect BHI regions ----
