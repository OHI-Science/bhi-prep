...
helcom_insect_list <- read.csv(file.path("C:/Users/Chester Gan/Downloads", "species.csv"), stringsAsFactors = FALSE) %>%
...
#### 2.4.3 Instituting threshold for presence

Observation data needs to be given a threshold for species to be considered present. This is to a rare occurrence of an individual being mistaken for species establishment. Based on the solution proposed in BHI 1.0, species will only be considered present when there at least 10 observations in each BHI region.
