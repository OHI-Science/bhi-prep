...
### 2.2 Organizing Data to Match 2015 Format
...
#### 2.2.2 Read in observations and add region data
...
#### 2.2.3 Reorganise into Presence/Absence
...
#### 2.2.4 Isolating and matching BHI ID and basins in raw data
...
spp_w_rgns %>% sf::st_drop_geometry() %>% select(Subbasin) %>% distinct() %>% nrow()  #18 basins
