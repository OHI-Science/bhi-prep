...
```{r Preamble}
loc <- file.path(here::here(), "prep", "CW", "trash")

source(file.path(here::here(), "R", "common.R"))

bkgd_path <- file.path(here::here(), "ref", "goal_summaries", "TRA.Rmd")
data_path <- file.path(here::here(), "data", "CW", "trash", assessment_yr, "tra_data.rmd")
