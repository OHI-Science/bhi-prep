...
```{r plot scores levels of aggregation, results = "show", echo = TRUE, fig.width = 7.5, fig.height = 4}
...
```{r plot basin mean across indicators, results = "show", echo = TRUE, fig.width = 7.5, fig.height = 4}
## Plot bhi mean score across indicators
...
```{r ao final score object plotted, results = "show", echo = TRUE, fig.width = 6, fig.height = 4}
...
**Plot slope**
```{r ao plot slope, results = "show", echo = TRUE, fig.width = 5.5, fig.height = 3.5}
...
```{r plot slopes, eval = FALSE, results = "show", echo = TRUE, fig.width = 6.5, fig.height = 3.5}
...
```{r mean slope by group per bhi region, results = "show", echo = TRUE, fig.width = 9.5, fig.height = 5.5}
...
```{r ao mean indicator slope, results = "show", echo = TRUE, fig.width = 6.5, fig.height = 3.5}
...
```{r ao bhi mean slope, results = "show", echo = TRUE, fig.width = 6.5, fig.height = 3.5}
...
```{r ao functional group mean slope, results = "show", echo = TRUE, fig.width = 6.5, fig.height = 3.5}
...
```{r ao plot final code object, results = "show", echo = TRUE, fig.width = 6.5, fig.height = 4}
