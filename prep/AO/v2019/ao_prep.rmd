...
Since there will be 12 BHI regions with NA assigned to them (due to missing data or no sampling there), the status score will be calculated at BHI region scale (therefore skipping the 'subbasin' scale).
...
monitoring_indicator_mean <- coastalfish_rgns1 %>% 
  dplyr::select(
