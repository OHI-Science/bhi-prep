...
#### 2.3.2 Select Baltic Sea countries
...
####  2.4.1  Plot WGI scores (WGI scale)
...
####  2.4.2  Plot WGI scores  - OHI global rescale
...
### 2.5 Rescale to the Baltic region

#### 2.5.1 Select Min and Max
...
#### 2.5.3 Plot rescaled to Baltic Region
...
#### 2.5.4 Plot and Compare Rescaling options
...
### 2.6 Assign country scores to BHI regions

#### 2.6.1 Join BHI region lookup to country scores
