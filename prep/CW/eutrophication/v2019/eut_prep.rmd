...
ggplot(secchi_subbasin_mean_months) + 
...
secchi_bhi_status <- secchi_subbasin_status %>%
  ...
  dplyr::select(bhi_id, dimension, score=status, region)
...
## Plot mean monthly value by subbasin
ggplot(chla_subbasin_mean_months) + 
...
# Plot summer mean secchi
ggplot(chla_subbasin_mean_months_summer) + 
