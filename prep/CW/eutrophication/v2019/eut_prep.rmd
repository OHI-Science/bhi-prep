...
secchi_lm_estim <- secchi_status_allyrs %>%
  ...
  right_join(secchi_status_allyrs %>% filter(yeaar %in% trendyrs), by  = "subbasin") %>%
...
# Strange how little offshore ICES chla, why is it completely missing in the north? It looks also that NEST data is missing some countries (Eg. Finland /SYKE) which should be there.
```
