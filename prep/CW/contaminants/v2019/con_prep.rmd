...
cwcon_indicators <- function(datalayer, yrs = 2010:2019, bio_thresh = 75, sed_thresh = 4.1, approach = "scaledObs", trendlag = 5){
...
ggplot(boxplotdf) + 
  ...
  geom_boxplot(aes(year, meanAdjww, color = countObs, fill = countObs), show.legend = FALSE, alpha = 0.4, outlier.size = 0.3) + 
...
```{r pfos map of data records, results = "show", fig.width = 9.5, out.width = "100%"}
...
#### 3.2.4 Status and trend options and calculation
