---
title: "Open sea anoxia pressure layer prep"
output:
  html_document:
    toc: true
    toc_depth: 4
...
```{r anoxia pressure preamble prep, message = FALSE}
...
data_path <- here::here("data", "pressures", "open_sea_anoxia", version_year, "open_sea_anoxia_data.rmd")
```
...
```{r read in the oxygen debt data and eutrophication targets}
## read in the oxygen debt data, prepared in the eutrophication goal prep
