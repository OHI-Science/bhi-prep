...
HELCOM sub-basin specific reference points for the _winter (DIN), (DIP), and summer chlorophyll_ a are set according to the HELCOM thresholds (HELCOM 2018). In addition, thresholds for chlorophyll a in coastal areas are also set according to the HELCOM thresholds (HELCOM 2018).
